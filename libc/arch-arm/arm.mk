...
$(error "TARGET_CPU_VARIANT not set or set to an unknown value. Possible values are cortex-a5, cortex-a7, cortex-a8, cortex-a9, cortex-a15, scorpion, krait. Use generic for devices that do not have a CPU similar to any of the supported cpu variants.")
endif
